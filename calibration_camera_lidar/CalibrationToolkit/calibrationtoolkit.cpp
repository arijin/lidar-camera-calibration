    ...
    : CalibrateCameraChessboardBase(patternSize,patternNum,parent)
{
    ...
    /*QLabel * calibvelshow=new QLabel("Image");
    QScrollArea * scrollarea=new QScrollArea;
    scrollarea->setWidget(calibvelshow);
    velodynetab->addTab(scrollarea,"Timestamp");*/
}
...
bool CalibrateCameraVelodyneChessboardBase::refreshVelodyne()
{
    ...
    //glClearColor(1.0f,1.0f,0.0f,1.0f);
    //std::cout << "refresh velodyne le yao:" << colors[0] << std::endl;
